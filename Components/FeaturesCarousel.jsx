export default function FeaturesCarousel() {
  ...
  return (
    <div className="w-full mx-auto flex flex-col justify-center items-center bg-[#F9F9F9] relative">
      ...
      <section className='flex flex-col justify-start items-center text-center w-full h-full py-[34px] md:py-[58px] gap-[36px] tracking-wider'>
        <h2 className=" text-black text-lg md:text-2xl font-semibold mx-auto  md:px-[50px]">Over 100+ services to integrate</h2>
