...
const Problem = () => {
    return (
        <div id="introduction" className='flex flex-col w-full max-h-screen items-center text-center bg-white overflow-hidden tracking-wider py-10 md:py-32 lg:py-[152px] px-4'>
