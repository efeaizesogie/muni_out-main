  ...
  return (
    <div className='flex flex-col w-full h-full 2xl:h-screen items-center relative overflow-hidden'>
      <Image 
        ...
        priority
      />
      <div className="md:w-[80%] md:pt-[200px] pt-[125px] gap-2 md:px-0 px-[15px] relative z-10">
        <div className="flex lg:flex-row flex-col w-full">
          ...
          <div className='w-full flex items-center justify-center px-[15px]'>
            <Image src={image1} className='w-full z-[2] ml-[120px] lg:min-w-[472px] lg:mt-[100px] lg:ml-[100px]' />
            <Image 
              src={image2} 
              className='w-full z-[1] lg:min-w-[899px] lg:ml-[-100px] lg:mt-[-50px] lg:animate-slideLeft200 animate-slideLeft100' 
            />
          </div>
        </div>
