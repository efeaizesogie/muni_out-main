...
const Footer = () => {
    return (
        <div className='flex flex-col w-full relative overflow-hidden hero-bg'>
            <Image
                src={footerbg}
            ...
            <div className="mx-5 2xl:w-full max-w-[1440px] md:mx-[100px] 2xl:mx-auto pt-[30px] md:pt-[77px] pb-10 z-10">
                <div className="w-full">
                    <div className="w-full flex flex-col items-center text-center justify-center mb-12">
                        ...
                        <div className="flex justify-center items-center gap-5 pt-10 md:pt-12 pb-4 md:pb-20 relative w-full">
                    ...
                    <div className="flex w-full flex-col md:flex-row gap-4 flex-wrap justify-between items-center pt-7 border-t border-[#EBEBEB1A]">
