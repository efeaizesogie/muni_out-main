        ...
        <div className="flex flex-col gap-[10px] py-[20px] md:py-[24px] border-b border-[rgba(135,147,143,0.4)] last:border-b-0">
            <div className="flex flex-col gap-[12px] md:gap-[14px] w-full">
                <div className="flex items-center gap-[12px] md:gap-[14px]">
                    ...
                    <h4 className="font-semibold text-[15px] md:text-[16px] leading-[20px] md:leading-[22px] tracking-[-0.01em] text-black">
                        {title}
                    </h4>
                </div>
                <p className="text-[13px] md:text-[14px] leading-[22px] md:leading-[26px] font-medium text-black w-full">
                    {description}
                </p>
            </div>
        </div>
