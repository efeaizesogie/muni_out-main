...
const FlowSectionCard = ({ consequences, title, titleBreak, desc, flow }) => {
    return (
        <div className="bg-[#FFFFFF] max-w-7xl mx-auto border-[1px] border-[#E9EAEB] rounded-[20px] mt-20 mx-4 lg:mx-auto relative">
            <div className="grid lg:grid-cols-2 gap-0 items-start">
                ...
                <div className="lg:border-l border-[#E9EAEB] border-t lg:border-t-0">
                    <div className="">
