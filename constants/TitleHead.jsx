...
const TitleHead = ({ tag, title, titleBreak, textWhite }) => {
    ...
    return (
        <>
            ...
            <h1 className={` ${textWhite ? "text-[#ffffff]" : "text-[#000000]"} " text-2xl md:text-4xl lg:text-[54px] font-semibold px-4 md:px-8 md:leading-[64px] max-w-4xl tracking-wider"`}>{title} <br /> {titleBreak}</h1>
        </>
    )
}
